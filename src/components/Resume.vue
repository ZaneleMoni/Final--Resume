      ...
      <li>
        <div class="direction-r">
          <div class="flag-wrapper">
            <span class="flag">Bulumko High</span>
            <span class="time-wrapper"
              ><span class="time"></span>January 2011- December 2015</span
            >
          </div>
          <div class="desc">Obtained my National Senior Certificate!</div>
        </div>
      </li>
...
.direction-r .flag:before {
  ...
  background: #fff;
  border-radius: 10px;
  border: 4px solid rgb(30, 138, 114);
  z-index: 10;
}
...
@media screen and (max-width: 660px) {
  ...
  .direction-r .flag:before {
    ...
    background: #fff;
    border-radius: 10px;
    border: 4px solid rgb(80, 243, 255);
    z-index: 10;
  }
